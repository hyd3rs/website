...
export const StandardBox = ({ title, children, right }) => (
    <div className={`flex flex-col gap-y-2 px-6 py-8 dark:bg-[#321d4e] bg-[#c6abe9] rounded-xl h-full ${right ? "md:text-right md:items-end md:flex-col-reverse" : "text-left items-start"} justify-center`}>
