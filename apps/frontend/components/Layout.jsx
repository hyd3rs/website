...
import { BiEnvelope, BiLogoGithub, BiLogoTwitter, BiSolidPaperPlane, BiSolidUser } from "react-icons/bi";
...
export const Links = (props) => {
    return (
        <>
            <StandardButtonLink icon href="mailto:hello@danny.works" external {...props}>
                <BiEnvelope />
            </StandardButtonLink>
            <StandardButtonLink icon href="https://github.com/daniwasonline" external {...props}>
                <BiLogoGithub />
            </StandardButtonLink>
