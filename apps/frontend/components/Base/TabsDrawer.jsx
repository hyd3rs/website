  ...
  return (
    <>
      <Card
        ...
        icon={PiHandWaving}
        href="/"
        className="border-cyan-900 group-hover:bg-cyan-900"
        invisible={invisible}
        setOpen={setOpen}
      >
      ...
      <Card
        title="projects"
        href="https://hydride.dev/projects"
        external
        icon={BiPaint}
        className="border-green-900 group-hover:bg-green-900"
        invisible={invisible}
        setOpen={setOpen}
      >
      ...
      <Card
        ...
        icon={BiPencil}
        href="/corner"
        className="border-red-900 group-hover:bg-red-900"
        invisible={invisible}
        setOpen={setOpen}
      >
...
export const TabsDrawer = () => {
  ...
  return (
    <>
      <Transition
        show={open}
        className="hidden md:block bg-white/65 dark:bg-black/65 absolute z-3 top-0 left-0 w-full h-full"
        ...
        <div className="flex flex-col gap-y-4 transition-all ease-in-out duration-500">
          <div className="z-5 pl-8 sm:pl-12">
            <button
              ...
              className={`transition-all ease-in-out duration-300 z-10 text-black dark:text-white hidden md:flex flex-col items-center justify-center p-2 h-12 w-12 rounded-2xl border-2 bg-transparent border-slate-900 hover:text-white hover:bg-slate-900 dark:border-purple-900 dark:hover:bg-purple-900`}
            >
              {open ? (
